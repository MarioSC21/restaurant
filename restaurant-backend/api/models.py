...
class Mesa(models.Model):
    mesa_id = models.AutoField(primary_key=True) #para crear el id
    mesa_nro = models.CharField(max_length=10,verbose_name="Nro Mesa")  #verbose_name > sirve para el admin de django
...
class Plato(models.Model):
    ...
    categoria_id = models.ForeignKey(Categoria,related_name='Platos',
                                    to_field='categoria_id',on_delete=models.RESTRICT, #to_field > lo usamnos pq nosotros hemos creado el ID
...
class Pedido(models.Model):
    ...
    usu_id = models.ForeignKey(User,to_field='id',related_name='Pedidos', #related_name > se usa para referencial en el serializer
